...
if __name__ == "__main__":
    ...
    create_dir("/content/drive/MyDrive/clinic_sd_unet")
    ...
    model_path='/content/drive/MyDrive/clinic_sd_unet/model.h5'
    batch_size = 16
    epochs = 100
    lr = 1e-4
    ...
    callbacks = [
        ...
        CSVLogger("/content/drive/MyDrive/clinic_sd_unet/data.csv"),
        TensorBoard(),
